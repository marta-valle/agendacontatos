...
<body>
  ...
  <div class="container mt-4">
  	...
  	<div class="mt-4 mb-4">
  		...
  		<form method="post" action="alterar-senha" onsubmit="return validarSenhas()"> <!--onsubmit serve para que antes de enviar para o controlador, executar uma função  -->
  ...
  <!-- Bloco de codigo JS - para a função onsubmit -->
  <script>
  	// FUNCTION É A AÇÃO QUE SERÁ TOMADA ---- LEMBRANDO QUE AS VARIAVEIS DEVEM SER IDENTICAS AO ID
		 	 function	validarSenhas(){
  	//CAPTURA O CAMPO 'novaSenha'
  		var novaSenha = document.getElementById('novaSenha');
  	//CAPTURA O CAMPO 'NOVASENHACONFIRMAÇÃO'
